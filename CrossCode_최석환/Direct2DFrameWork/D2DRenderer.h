...
public:
	...
	void DrawLine(Vector2 start, Vector2 end,  D2D1::ColorF::Enum color,  float alpha,
		  float strokeWidth = 1.f);
	void DrawLine(Vector2 start, Vector2 end,  DefaultBrush defaultBrush = DefaultBrush::Black,
		  float strokeWidth = 1.f);
	...
	void DrawRectangle( RECT  rc,  DefaultBrush defaultBrush = DefaultBrush::Black,
		  float strokeWidth = 1.f);
	void DrawEllipse(Vector2 origin,  float radius,  DefaultBrush defaultBrush = DefaultBrush::Black,
		   float strokeWidth = 1.f);
	void DrawEllipse(Vector2 origin,  float radius,  D2D1::ColorF::Enum color,  float alpha,
		  float strokeWidth = 1.f);
	...
	void FiilEllipse(Vector2 origin,  float radius,  D2D1::ColorF::Enum color,  float alpha);
	void FiilEllipse(Vector2 origin,  float radius,  DefaultBrush brush = DefaultBrush::Black);
};
